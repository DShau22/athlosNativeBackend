...
const following = require('./community/following')
...
router.post("/cancelFollowRequest", following.cancelFollowRequest);
router.post("/unfollow", following.unfollow);
router.post("/follow", following.follow)
